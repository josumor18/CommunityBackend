...
class DeviceTokensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device_token" do
    assert_difference('DeviceToken.count') do
      post device_tokens_url, params: { device_token: { id_user: @device_token.id_user, token: @device_token.token } }
    end
  ...
  test "should update device_token" do
    patch device_token_url(@device_token), params: { device_token: { id_user: @device_token.id_user, token: @device_token.token } }
