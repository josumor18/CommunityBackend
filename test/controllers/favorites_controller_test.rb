...
class FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite" do
    assert_difference('Favorite.count') do
      post favorites_url, params: { favorite: { id_news: @favorite.id_news, id_user: @favorite.id_user } }
    end
  ...
  test "should update favorite" do
    patch favorite_url(@favorite), params: { favorite: { id_news: @favorite.id_news, id_user: @favorite.id_user } }
