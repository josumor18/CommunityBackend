...
class RequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create request" do
    assert_difference('Request.count') do
      post requests_url, params: { request: { id_community: @request.id_community, id_user: @request.id_user } }
    end
  ...
  test "should update request" do
    patch request_url(@request), params: { request: { id_community: @request.id_community, id_user: @request.id_user } }
